...
def parse_config(argv=None):
    ...
    args = parser.parse_args(['--config', 'cfg_files/fit_smplx.yaml' ,'--data_folder', 'run', '--output_folder', 'out', '--model_folder', 'models', '--vposer_ckpt', 'vposer', '--input_media', 'image/0001.jpg'])
    args_dict = vars(args)
    return args_dict
